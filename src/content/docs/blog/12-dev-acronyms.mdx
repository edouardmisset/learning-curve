...
<Aside type="note">
  See the [dedicated post on SOLID](/learning-curve/blog/11-solid-principles)
</Aside>
...
<Aside type="note">
  See the basic [CRUD](/learning-curve/snippets/sql/crud) example
</Aside>
...
<Aside type="note">
  See the [ACID](/learning-curve/blog/13-acid) post for a deeper dive
</Aside>
