...
Higher-order functions provide functional alternatives to many traditional [design patterns](/learning-curve/blog/20-design-patterns). For example, they can replace patterns like Decorator, Strategy, and Command with simpler function composition.
