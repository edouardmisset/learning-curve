...
See the [Generics](/learning-curve/blog/02-generics) article for more details.
...
Design patterns are typical solutions to common problems in software design. To learn more about how to apply design patterns in TypeScript with practical examples, see [Design Patterns in TypeScript](/learning-curve/blog/20-design-patterns).
...
- **[SOLID Principles](/learning-curve/blog/11-solid-principles)**: A set of five design principles intended to make software designs more understandable, flexible, and maintainable.
- **[DRY (Don't Repeat Yourself)](/learning-curve/blog/10-dry-principle)**: Reduces repetition of software patterns, replacing it with abstractions or using data normalization.
