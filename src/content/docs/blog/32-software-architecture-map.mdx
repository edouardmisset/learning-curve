...
that relationship, see [How the Internet Works, Layer by Layer](/my-learning-curve/blog/30-internet-layers).
...
[Design Patterns in TypeScript](/my-learning-curve/blog/20-design-patterns).
...
- **Rendering:** The storefront uses server-side rendering with interactive
  components. See [Web Rendering Patterns](/my-learning-curve/blog/19-web-rendering-patterns)
